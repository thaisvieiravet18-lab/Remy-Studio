...
const deliverables = [
  {
    ...
    icon: Monitor,
    description: 'Strategic structure with premium design and total focus on converting visitors into veterinary clients.',
    metric: 3,
    prefix: '+',
    suffix: 'x',
  ...
  },
  {
    ...
    icon: Star,
    description: 'Strategic visual content with script, editing and persuasive copy to attract pet owners every day.',
    metric: 120,
    prefix: '+',
...
function MetricCounter({ value, prefix = '', suffix = '' }: { value: number; prefix?: string; suffix?: string }) {
  ...
  return (
    <motion.span
      ref={ref}
      animate={isInView ? { scale: [0.8, 1.1, 1], opacity: 1 } : { opacity: 0.5 }}
